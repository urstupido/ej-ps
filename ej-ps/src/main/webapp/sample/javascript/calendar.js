		   ...
		   var arr_months = ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", 
			...
			else
			{
		        ...
		        var str_buffer = new String (
	                    ...
	                    "</style>\n"+ 
		                "</head>\n"+
		                "<body background=\"./sample/images/calendar/ct_diary_bg2.gif\" style=\"margin:8\">\n"+ 
		                "<table border=\"0\" cellpadding=\"1\" cellspacing=\"1\" bgcolor=\"C5C5C5\">\n"+ 
		                "<tr><td align=\"center\" background=\"./sample/images/calendar/ct_diary_bg.gif\" bgcolor=\"#ffffff\" style=\"border:FFFFFF solid 1px; padding:11 9 9 9\">\n"+ 
		                ...
		                "<img src=\"./sample/images/calendar/ct_diary_btn1.gif\" width=\"15\" height=\"13\" border=\"0\"></a> "+					
		                ...
		                "<img src=\"./sample/images/calendar/ct_diary_btn2.gif\" width=\"15\" height=\"13\" border=\"0\"></a> "+
						"<a href=\"javascript:window.opener.show_calendar('" +str_target+"', '"+tuning(dt_next_year)+"');\">"+ 
		                "<img src=\"./sample/images/calendar/ct_diary_btn2.gif\" width=\"15\" height=\"13\" border=\"0\"></a>"+
						"</td>\n</tr>\n</table>\n"+ 
		                "<!-- -------- 월 표시 E  -------- -->\n"+
		                "</td>\n</tr>\n<tr>\n<td bgcolor=\"EBEFF7\" height=\"1\">\n</td>\n</tr>\n<tr>\n"+
						"<td height=\"23\" align=\"center\" valign=\"bottom\"><img src=\"./sample/images/calendar/ct_diary_title.gif\"></td>\n"+
		        ...
		        var vWinCal = window.open("", "Calendar",
		        		//'fullscreen=1,toolbar=0,scrollbars=0,location=0,status=0,menubar=0'
		                "width=200,height=250,status=no,resizable=no,top=0,left=0");
		        vWinCal.focus();
		        vWinCal.opener = self;
